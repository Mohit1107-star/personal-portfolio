...
const Navbar = () => {
  ...
  return (
    ...
    <a href="#top">
      ...
      <ul className={`hidden md:flex items-center gap-6 lg:gap-6
      lg:gap-8 rounded-full px-12 py- ${isScroll ? "": 
      ...
      <div className='flex items-center gap-4'>
        ...
        gap-3 px-10 py-2 border border-gray-500 rounded-full ml-4'>Contact 
       ...
       bg-rose-50 translation duration-500'>
